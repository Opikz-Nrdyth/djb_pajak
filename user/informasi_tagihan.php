...
<head>
    ...
    <link rel="stylesheet" href="<?php echo BASE_URL_USER_ROOT . $root_project; ?>assets/css/user-informasi-tagihan.css?v=<?php echo time(); ?>">

    <link rel="stylesheet" href="<?php echo BASE_URL_USER_ROOT . $root_project; ?>assets/css/user-informasi-tagihan-content.css?v=<?php echo time(); ?>">

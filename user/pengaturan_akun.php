...
<head>
    ...
    <link rel="stylesheet" href="<?php echo BASE_URL_USER_ROOT . $root_project; ?>assets/css/user-pengaturan-akun.css?v=<?php echo time(); ?>">
    <link rel="stylesheet" href="<?php echo BASE_URL_USER_ROOT . $root_project; ?>assets/css/user-pengaturan-akun-content.css?v=<?php echo time(); ?>">

...
<head>
    ...
    <link rel="stylesheet" href="<?php echo BASE_URL_ADMIN . $root_project; ?>assets/css/admin-rekaptulasi.css?v=<?php echo time(); ?>">
        ...
        function printLaporan(elementId, reportTitle, reportPeriod) {
            ...
            const headerHtml = `
                <div style="text-align:center; margin-bottom:20px; font-family: Arial, sans-serif;">
                    <img src="<?php echo BASE_URL_ADMIN . $root_project; ?>assets/images/logo_djp_admin.png" alt="Logo" style="height:50px; margin-bottom:10px;">
                    <h2>${reportTitle}</h2>
